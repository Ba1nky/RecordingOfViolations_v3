    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "вулиця Інститутська, 22", new DateTime(2022, 10, 23, 18, 28, 45, 686, DateTimeKind.Local).AddTicks(6964), "Cпівак Олег", "Кукурудза Валерій", 1750m, 3 },
                    { 2, "Львівське шосе, 38/1", new DateTime(2022, 10, 8, 18, 28, 45, 686, DateTimeKind.Local).AddTicks(6975), "Ткачук Петро", "Щур Сергій", 510m, 1 },
                    { 3, "вулиця Соборна, 11", new DateTime(2022, 10, 29, 18, 28, 45, 686, DateTimeKind.Local).AddTicks(6982), "Олійник Яна", "Щур Сергій", 750m, 4 },
                    { 4, "вулиця Трудова, 6А", new DateTime(2022, 10, 17, 18, 28, 45, 686, DateTimeKind.Local).AddTicks(6989), "Пристувчук Олександр", "Кукурудза Валерій", 15000m, 2 }
                });
